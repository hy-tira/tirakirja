...
Muutamme nyt ongelman asettelua niin,
että haluamme etsiä lyhimmät polut verkon
...
Floyd-Warshallin algoritmi muodostaa $n \times n$ -kokoisen
\emph{etäisyysmatriisin},
...
lyhimmät polut etsivistä algoritmeista.
...
mutta tämä ei yleensä aiheuta vaikeuksia käytännön ongelmissa.
