...
Kuten pian huomaamme, algoritmia riittää suorittaa $n-1$ kierrosta,
missä $n$ on verkon solmujen määrä.
Tämän jälkeen algoritmi on varmasti löytänyt
kaikki lyhimmät polut lähtösolmusta alkaen.
Voimme siis toteuttaa algoritmin seuraavasti:
