...
Tähän mennessä olemme käsitelleet verkkoja,
joissa voimme kulkea kaaria kumpaankin suuntaan.
Tässä luvussa keskitymme sen sijaan verkkoihin,
joissa jokaisella kaarella on merkitty suunta,
jonka mukaisesti meidän täytyy kulkea sitä.
Sanomme, että verkko on \emph{suuntaamaton},
jos voimme kulkea kaaria molempiin suuntiin,
ja \emph{suunnattu}, jos kaarilla on merkityt suunnat.
...
välinen kaari on suunnattu niin, että pystymme kulkemaan
...
tai todeta, että verkossa on sykli eikä mitään
topologista järjestystä ole olemassa.
...
solmuun $4$ on kaari solmuista $2$, $3$ ja $5$.
Tämän seurauksena
...
Tässä verkossa solmusta $0$ solmuun $6$ on yhteensä $24$ polkua,
...
\emph{Kosarajun algoritmi} muodostuu kahdesta vaiheesta,
...
Syvyyshaun aikana lisäämme aina solmun listalle
