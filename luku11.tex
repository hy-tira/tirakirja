...
Kierroksella $i$ algoritmi etsii polkuja, joissa on välisolmuna
solmu $i$ sekä mahdollisesti solmuja $1,2,\dots,i-1$.
...
ja vaiheessa $i$ parannamme etäisyyksiä poluilla, jotka kulkevat solmun $i$
(ja mahdollisesti solmujen $1,2,\dots,i-1$) kautta.
