...
Testaamme algoritmia tapauksessa, jossa $n=20$ ja jokainen
taulukossa \texttt{hinta} oleva arvo on satunnainen
kokonaisluku välillä $1 \dots 100$.
Tässä tapauksessa algoritmi kävisi läpi $20!$ eri ratkaisua,
...
Siinä ideana on käydä läpi ratkaisuja haarautuvasti,
kuten yleensäkin peruuttavassa haussa,
mutta tehostaa hakua karsimalla selkeästi huonoja ratkaisuja
...
Tässä funktion \texttt{arvio} tulee antaa jokin alaraja,
paljonko maksaa ainakin palkata jäljellä olevat työntekijät $k \dots n-1$.
Yksi helppo tapa saada alaraja on laskea yhteen jokaisen jäljellä olevan
työntekijän \emph{halvin} hinta välittämättä työtehtävistä.
