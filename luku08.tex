...
on valita aina seuraavaan koriin \emph{raskain} lapsi sekä sen pariksi
jokin toinen lapsi niin, että painojen summa ei ylitä
korin maksimipainoa.
Jos ei ole mitään tapaa valita toista lasta,
laitamme raskaimman lapsen koriin yksin.
...
Raskain lapsi täytyy sijoittaa johonkin koriin,
...
parina raskaimman lapsen kanssa, niin se voi toimia parina
...
koriin tuleva raskain lapsi sekä mahdollinen sen pariksi tuleva lapsi.
...
osoittaa aina raskaimman lapsen painoon.
Algoritmi laskee muuttujaan $k$, montako koria tarvitaan yhteensä.
Jos kevyimmän ja raskaimman lapsen
