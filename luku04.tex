...
\hline
$10^6$ & 0.03 s & 0.03 s \\
$2 \cdot 10^6$ & 0.04 s & 0.20 s \\
$4 \cdot 10^6$ & 0.11 s & 0.36 s \\
$8 \cdot 10^6$ & 0.32 s & 0.90 s \\
$16 \cdot 10^6$ & 1.43 s & 2.40 s \\
\end{tabular}
\caption{Listan luomisen tehokkuusvertailu.}
\label{tab:lisluo}
\end{table}
...
\hline
$10^6$ & 0.01 s & 0.01 s \\
$2 \cdot 10^6$ & 0.01 s & 0.02 s \\
$4 \cdot 10^6$ & 0.01 s & 0.03 s \\
$8 \cdot 10^6$ & 0.02 s & 0.05 s \\
$16 \cdot 10^6$ & 0.03 s & 0.10 s \\
\end{tabular}
\caption{Listan läpikäynnin tehokkuusvertailu.}
\label{tab:lislap}
\end{table}

Taulukot \ref{tab:lisluo} ja \ref{tab:lislap}
näyttävät testien tulokset.
Osoittautuu, että listan luominen on selvästi hitaampaa
kuin läpikäynti, mikä on ymmärrettävää, koska luomisessa
täytyy varata tilaa muistista uusille alkioille.
Lisäksi taulukkolista toimii tehokkaammin
molemmissa testeissä kuin linkitetty lista.
Kysymys kuuluukin:
