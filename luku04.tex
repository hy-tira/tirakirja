...
Tarkastellaan tilannetta, jossa listaan on lisätty $n$ alkiota
ja taulukon kokoa kasvatettiin viimeksi alkion $k \le n$
lisäyksen yhteydessä.
Haluamme laskea, montako alkiota kopioitiin
taulukosta toiseen prosessin aikana.
Koska jokainen taulukon kasvatus kaksinkertaisti sen koon,
kopioitujen alkioiden määrä on
$k+k/2+k/4+\dots \le 2k = O(n)$,
