...
Taulukon tavoin lista sisältää joukon alkioita
tietyssä järjestyk\-sessä,
mutta voimme lisäksi muuttaa listan kokoa
lisäämällä ja poistamalla alkioita.
...
Meidän täytyy vain keksiä, miten voimme lisätä ja poistaa
alkioita, vaikka taulukon koko on kiinteä.
Löydämme ongelmaan pian ratkaisun, mutta sitä ennen
aiheellinen kysymys on:
miksi ohjelmointikielten suunnittelijat eivät ole antaneet meille
suoraan mahdollisuutta muuttaa taulukon kokoa?
...
Tarkastellaan esimerkkiä, jossa ohjelmassa on käytössä
taulukot $[1,4,2]$ ja $[5,3,2,5]$.
...
Jos lisäisimme taulukon $[1,4,2]$ perään uuden alkion,
meidän täytyisi tuhota taulukon $[5,3,2,5]$ ensimmäinen alkio,
...
yhden listan alkion.
Linkitetty lista voi olla joko yhteen tai kahteen suuntaan linkitetty.
...
Molemmissa listoissa meillä on viittaukset listan
alkuun ja loppuun.
Yhteen suuntaan linkitetyssä listassa voimme käydä
läpi listan alkiot alusta loppuun,
mutta kahteen suuntaan linkitetyssä listassa voimme
myös kulkea listalla takaperin.
...
Joudumme liikkumaan solmuihin linkkejä pitkin, koska solmut on tallennettu
muistiin sekalaisiin kohtiin eikä meillä ole keinoa tietää,
