...
Javan tietorakenne \texttt{HashMap} on hajautukseen
...
Tietorakenne \texttt{HashSet} on puolestaan
hajautusta käyttävä joukko, jonka operaatiot ovat tehokkaita.
...
Pythonin tietorakenne \texttt{dict} on hajautukseen perustuva hakemisto.
...
Tietorakenne \texttt{set} on puolestaan hajautusta käyttävä joukko.
