...
Hajautustaulun hienoutena on, että se toteuttaa
...
\section{Hajautustaulu algoritmiikassa}
...
Tarkastellaan ongelmaa, jossa haluamme laskea,
...
Hajautustaulu osoittaa kyntensä silloin,
kun haluamme pitää yllä aidosti \emph{dynaamista}
joukkoa algoritmin aikana eli haluamme pystyä
lisäämään, poistamaan ja hakemaan alkioita sekalaisessa järjestyksessä.
Tällaisessa tilanteessa emme voi enää korvata hajautustaulua
