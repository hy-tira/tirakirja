...
että meille annetaan $n$ lukua ja meidän tulee ilmoittaa
jokaisen luvun jälkeen, montako eri lukua olemme saaneet
tähän mennessä, ennen kuin saamme seuraavan luvun.
Voimme ratkaista tehtävän seuraavasti olettaen,
että voimme hakea lukuja funktiolla \texttt{hae\_luku}.
...
Tämän algoritmin aikavaativuus on $O(n)$,
koska se lisää jokaisella silmukan kierroksella yhden
luvun joukkoon ja hakee joukon koon.
Emme voisi ratkaista ongelmaa tehokkaasti
järjestämisellä, koska lukuja tulee yksi kerrallaan
eikä alussa ole mitään aineistoa, jonka voisi järjestää.
