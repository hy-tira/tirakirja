...
kaksi merkkijonoa saavat saman hajautusarvon,
jos niissä on samat merkit eri järjestyksessä.
Pystymmekin parantamaan hajautusarvon laskentaa lisäämällä
...
joukkoja ja hakemistoja, joiden operaatiot ovat tehokkaita.
Voimme alkajaisiksi ratkaista \emph{suoraviivaisemmin} sellaisia ongelmia,
joissa olemme käyttäneet aiemmin taulukon järjestämistä.
...
Näin saamme aikaan lyhyen algoritmin, joka toimii ajassa $O(n)$:
...
Tarkastellaan sitten toista ongelmaa, jossa haluamme selvittää,
...
Kuten nämä esimerkit osoittavat, voimme toteuttaa
hajautustaulun avulla algoritmeja helpommin
eikä meidän tarvitse kikkailla järjestämisen kanssa.
