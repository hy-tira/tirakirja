...
Leveyshaku on vaikeampaa toteuttaa kuin syvyyshaku,
koska meidän täytyy pystyä edistämään hakua verkon eri puolilta.
Tätä varten määritte\-lemme jonon, joka sisältää solmuja,
...
Voimme määritellä jonon näin:

\begin{code}
ArrayDeque<Integer> jono = new ArrayDeque<>();
\end{code}

Lisäksi määrittelemme taulukot, joiden avulla pidämme kirjaa,
...
kun pääsemme kaikkiin muihin verkon solmuihin läpikäynnin aikana.

Jos verkko ei ole yhtenäinen, voimme myös etsiä kaikki sen
komponentit läpikäynnin avulla.
Tässä tapauksessa käymme läpi kaikki verkon solmut.
...
toteamme, että verkko ei ole yhtenäinen, mutta olemme löytäneet
yhden sen komponentin, jossa on solmut 1, 2 ja 3.
...
Jos voimme käyttää kumpaa tahansa, syvyyshaku on käytännössä parempi
valinta, koska se on helpompi ohjelmoida.
