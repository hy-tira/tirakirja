...
Leveyshaku laskee jokaiselle verkon solmulle,
mikä on sen \emph{etäisyys} lähtösol\-musta eli kuinka pitkä on
\emph{lyhin polku} lähtösolmusta solmuun.
Lyhin polku tarkoittaa tässä polkua, jossa on pienin määrä kaaria.
Haku käsittelee solmut kerroksittain lähtösolmusta alkaen
siinä järjestyksessä kuin se löytää ne ja käy läpi
jokaisen solmun kohdalla kaikki siitä lähtevät kaaret.

Toteutamme leveyshaun käyttäen \emph{jonoa}, jossa on vierailtavia solmuja.
Jonon ansiosta pystymme käymään läpi solmut siinä
järjestyksessä kuin olemme löytäneet ne.
...
Tämän jälkeen alamme käydä läpi solmuja jonon järjestyksessä.
