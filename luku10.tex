...
\emph{Vierusmatriisi} (\emph{adjacency matrix}) on kaksiulotteinen taulukko,
...
Haku käynnistyy, kun kutsumme aliohjelmaa
\texttt{haku} parametrina haun lähtö\-solmu.
Jokaisessa kutsussa aliohjelma tarkistaa ensin,
olemmeko jo käy\-neet parametrina annetussa solmussa,
ja päättyy heti tässä tilanteessa.
Muuten aliohjelma merkitsee, että olemme nyt käyneet solmussa
