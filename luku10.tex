...
Huomaa, että syvyyshaku löytää \emph{jonkin} reitin ruudusta $A$ ruutuun $B$,
mutta ei välttämättä lyhintä reittiä.
Jos haluaisimme löytää lyhimmän reitin, meidän tulisi käyttää leveyshakua.
