...
jossa haluamme selvittää \emph{maksimivirtauksen}
verkon lähtösolmusta kohdesolmuun.
Tämä tarkoittaa, että haluamme löytää mahdollisimman
tehokkaan tavan välittää lähtösolmusta kohdesolmuun
jotain hyödykettä ottaen huomioon kaarten kapasiteetit.
...
Maksimivirtauksen muodostamisen jälkeen voimme tarkastella kaaria,
jotka vastaavat verkon alkuperäisiä kaaria, jotta näemme,
miten virtaus on muodostunut.
Kaarta kulkevan virtauksen määrä on yhtä suuri kuin
muutos kaaren painossa algoritmin aikana.
Esimerkiksi kuvassa \ref{fig:floesi} kaaren $4 \rightarrow 5$
paino on alussa 5 ja algoritmin suorituksen jälkeen 2.
Tämä tarkoittaa, että kaarta pitkin kulkevan virtauksen määrä on $5-2=3$.
...
Tästä huolimatta ei ole päältä päin todellakaan selvää,
