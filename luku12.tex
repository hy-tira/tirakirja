...
Keskeinen haaste verkkoalgoritmien suunnittelussa
ovat verkossa olevat syklit,
...
kun voimme olettaa, että käsiteltävänä on suunnattu verkko,
jossa \emph{ei ole} syklejä.

Kun verkko on suunnattu ja syklitön,
voimme muodostaa sille aina topologisen järjestyksen,
...
Jos kuitenkaan verkossa ei ole sykliä,
löydämme aina jonkin sopivan järjestyksen.

Seuraavaksi tutustumme algoritmiin,
jonka avulla voimme muodostaa topologisen järjestyksen
tai todeta, että verkossa on sykli eikä
topologista järjestystä ole olemassa.

\subsection{Järjestyksen muodostus}
...
Miten voimme tietää, että algoritmimme toimii
