...
vaikeuksia usein verkossa olevat syklit,
...
kun voimme olettaa, että käsitel\-tävänä on suunnattu verkko,
...
Tutustumme seuraavaksi syvyyshakuun perustuvaan
algoritmiin, joka muodostaa verkon topologisen järjestyksen
...
Algoritmimme on tehokas,
koska sen aikavaativuus on $O(n+m)$.
Mutta miten voimme tietää, että se
