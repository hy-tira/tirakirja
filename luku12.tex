...
Verkkoalgoritmien suunnittelussa keskeinen haaste ovat verkossa olevat syklit,
koska monessa tilanteessa syklien takia meidän on hankalaa päättää,
missä järjestyksessä kävisimme läpi verkon solmuja.
Jos voimme olettaa, että verkossa ei ole syklejä,
voimmekin ratkaista monia verkko-ongelmia helpommin kuin yleisissä verkoissa,
...
Voimme muodostaa tällaisille verkoille topologisen
järjestyksen, joka antaa solmuille luontevan käsittelyjärjestyksen,
ja käyttää dynaamista ohjelmointia verkko-ongelmien ratkaisemiseen.
