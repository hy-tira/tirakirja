...
Bellman–Fordin algoritmi määrittää etäisyyden
(eli lyhimmän polun pituuden) valitusta lähtösolmusta
kaikkiin verkon solmuihin.
Algoritmi pitää yllä \emph{arvioita} etäisyyksistä niin,
että aluksi etäisyys lähtösol\-muun on 0 ja etäisyys
kaikkiin muihin solmuihin on $\infty$ (ääretön).
...
todellisia lyhimmän polun pituuksia.
