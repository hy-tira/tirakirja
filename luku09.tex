...
\emph{Dynaaminen ohjelmointi} on tekniikka,
jonka avulla voi monessa tilanteessa
laskea ongelman ratkaisujen yhteismäärän tai
löytää ratkaisun, joka on jollain mittarilla optimaalinen.
Ideana on muotoilla ongelma rekursiivisesti niin,
että voimme laskea halutun asian
saman ongelman pienempien osaongelmien avulla.
...
Binomikerroin $\binom{n}{k}$ ilmaisee, monellako tavalla voimme
