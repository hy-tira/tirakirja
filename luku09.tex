...
Saamme aikaan tehokkaan ratkaisun aloittamalla tapauksesta
...
Ideana on, että meillä on kaksi tapaa muodostaa $k$ alkion osajoukko
joukosta $\{1,2,\dots,n\}$.
...
$k$ alkion osajoukko samaisesta joukosta.
...
Tämä rekursiivinen määritelmä tarjoaa meille tavan laskea tehokkaasti
...
Tämän koodin suorituksen jälkeen taulukon kohdassa
