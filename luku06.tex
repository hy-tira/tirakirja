...
että joukon operaatiot vievät aikaa $O(\log n)$
kaikissa tapauksissa.
Käytännössä binäärihakupuu toimii hieman hitaammin
kuin hajautustaulu, mutta siinä ei ole teoreettista riskiä,
että operaatiot veisivät aikaa $O(n)$.
