...
Tämän ansiosta voimme toteuttaa myös esimerkiksi seuraavat operaatiot:
...
Hajautustaulu \emph{ei} pysty tarjoamaan näitä operaatioita,
koska alkiot ovat siinä sekalaisessa järjestyksessä.

Jotta binäärihakupuu toimii tehokkaasti,
meidän täytyy varmistaa,
että puu on tasapainoinen eli alkiot jakautuvat
tasaisesti sen eri puolille.
Tällöin kaikki puun operaatiot toimivat ajassa $O(\log n)$.
Tässä luvussa tutustumme esimerkkinä AVL-puuhun,
joka on varhaisin tunnettu tapa luoda tasapainoinen
binäärihakupuu.
...
\emph{Binäärihakupuu} on binääripuu, jonka kunkin solmun
...
kannattaa miettiä, voisimmeko käyttää järjestämistä
tavalla tai toisella joukkojen sijaan.
