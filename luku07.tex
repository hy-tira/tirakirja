...
jos jossain alipuussa lasten korkeudet ovat ennen lisäämistä
$x$ ja $x+1$ ja lisäämisen jälkeen $x$ ja $x+2$.
...
Pystymme korjaamaan AVL-ehdon solmun lisäämisen jälkeen
kiertämällä puun solmuja sopivasti.
Kuva \ref{fig:avlkie} näyttää kierrot, joita käytämme korjaamisessa.
...
Esimerkissämme voimme kiertää solmuja niin,
että solmu $7$ nousee ylimmäksi,
jolloin tuloksena on kuvan \ref{fig:avlkor} puu.
Tämän muutoksen jälkeen AVL-ehto pätee jälleen puussa,
koska solmun $7$ kummankin alipuun korkeus on 1.

Yleisessä tapauksessa voimme korjata AVL-ehdon
solmun lisäämisen jäl\-keen kulkemalla puussa ylöspäin,
kunnes löydämme solmun, jossa AVL-ehto ei päde.
