...
Joissakin ohjelmointikielissä binäärikekoon perustuvasta
tietorakenteesta käytetään nimeä \emph{prioriteettijono} (\emph{priority queue}).
...
Toteutuksessa keko on minimikeko ja 0-indeksoitu
(eli keon pienin alkio on aina kohdassa 0).
